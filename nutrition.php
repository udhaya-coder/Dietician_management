...
if(isset($_POST['btn']))
{
$qry=mysqli_query($conn,"select * from nutrician where uname='$uname' && psw='$password'");
$num=mysqli_num_rows($qry);
if($num==1)
{

$qry1=mysqli_query($conn,"select * from nutrician where uname='$uname' && psw='$password'");
$row=mysqli_fetch_assoc($qry);
$_SESSION['nid']=$row['id'];
$_SESSION['name']=$row['name'];
echo "<script>alert('Welcome To Nutriccian Page')</script>";
...
<body>
 ...
 <form id="form1" name="form1" method="post" action="">
	   <table width="52%" border="0" align="center">
         <tr>
           <td colspan="2" rowspan="1"><div align="center" class="style1"><strong><font size="+1">Nutrician Login</font> </div></td>
		 </tr>
			<tr>
		<td width="38%">&nbsp;</td>
		    <td width="35%">&nbsp;</td>
         ...
         <tr>
		  ...
		  <tr>
           <td>&nbsp;</td>
           <td width="27%"><label>
            <a href="nregister.php"> Nutrician Registration</a>
           </label></td>
         </tr>
