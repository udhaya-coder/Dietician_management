...
<form id="f1" name="f1" method="post" action="#">
  <table width="35%" height="410" border="0" align="center">
   ...
   <tr>
      ...
      <td width="35%" height="42">Name</td>
      <td width="65%"><input name="name" type="text" id="name" onChange="return name ()" required/>
      </td>
  ...
  <tr>
	 ...
	 <tr>
	  ...
	  <tr>
      <td height="34">Phone Number </span></td>
